...
$result = mysqli_query($con, "SELECT id, thread_name, thread_price, thread_remaining_quantity FROM threads ORDER BY thread_name ASC");
...
<body>
                    ...
                    <table class="table datatable-multi-sorting">
                        <thead>
                            <tr>
                                ...
                                <th>Thread Remaining Quantity</th>
                                <th>Thread Price </th>
    ...
    function updateDatabase(id, field, value) {
        ...
        xhr.open('POST', 'thread_inventory_and_price_update.php', true);
