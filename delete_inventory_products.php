                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                ...
                                <a href="delete_thread.php" style='color:white'>
                                     <div class="col-lg-4">
                                        <div class="panel bg-pink-400">
                                            <p style="margin: 10px; font-size: large;">Delete Thread</p>
                                        </div>
                                    </div>
                                </a>
                                 <a href="delete_bladder.php" style='color:white'>
                                     <div class="col-lg-4">
                                        <div class="panel bg-pink-400">
                                ...
                                <a href="delete_ink.php" style='color:white'>
                                     <div class="col-lg-4">
                                        <div class="panel bg-pink-400">
                                            <p style="margin: 10px; font-size: large;">Delete Ink</p>
                                        </div>
                                    </div>
                                </a>
                                <a href="delete_products.php" style='color:white'>
                                    <div class="col-lg-4">
                                        <div class="panel bg-pink-400">
                                            <p style="margin: 10px; font-size: large;">Delete Products</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
