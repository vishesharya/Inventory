...
if (isset($_POST['submit_products'])) {
    ...
    if (empty($temp_products)) {
        ...
        foreach ($temp_products as $product) {
            ...
            $ist_quantity = mysqli_real_escape_string($con, $product['ist_quantity']);
            $iind_quantity = mysqli_real_escape_string($con, $product['iind_quantity']);
            $date_and_time = mysqli_real_escape_string($con, $product['date_and_time']);
     
            // Insert product into the database
            $insert_query = "INSERT INTO kits_received (challan_no, labour_name, product_name, product_base, product_color,ist_quantity,iind_quantity,date_and_time) 
