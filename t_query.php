...
if (isset($_POST['view'])) {
    ...
    if (!empty($from_date) && !empty($to_date)) {
        $whereClause = "AND date BETWEEN '$from_date' AND '$to_date'";
    }
}
?>
<!DOCTYPE html>
            ...
            <!-- start print code  -->
                ...
                <div class="pad margin no-print">
                    <div class="callout callout-info" >       
                       <form action="t_query.php" method="POST" class="form-horizontal" enctype="multipart/form-data" target="_self" autocomplete="off">
                        <div class="box-body">
                            
                            <div class="form-group">
                            <label for="from_date" class="col-sm-1 control-label">From Date</label>
                            <div class="col-sm-2">
                                <input type="date" class="form-control datepicker" name="from_date" id="from_date">
                            </div>
                ...
                <!-- Content area -->
                    ...
                    <div class="panel panel-flat" style="overflow: auto;">
                        ...
                        <table class="table datatable-multi-sorting">
                            ...
                            <?php 
                            $sn=1;
                            $result=mysqli_query($con, "SELECT * FROM contact WHERE product = 'Tennis Ball' $whereClause");
