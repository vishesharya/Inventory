...
$query = "SELECT * FROM kits_return ORDER BY id DESC LIMIT 1";
...
$product_query = "SELECT * FROM kits_return WHERE challan_no = '$challan_no'";
...
$date_and_time_query = "SELECT date_and_time FROM kits_return WHERE challan_no = '$challan_no' LIMIT 1";
