                ...
                <div class="content">
                    <div class="pad margin no-print">
                        <div class="callout callout-info">
                            <form action="print_kits_receive_data.php" method="POST" class="form-horizontal" enctype="multipart/form-data"  autocomplete="off">
                                <div class="box-body">
                    ...
                    <div class="panel panel-flat" style="overflow: auto;">
                        ...
                        <table class="table datatable-multi-sorting">
                            ...
                            <tbody>
                                <?php 
                                $sn=1;
                                $result=mysqli_query($con, "SELECT * FROM kits_received"); // Selecting all fields from the kits_received table
