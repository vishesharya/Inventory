                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                ...
                                <a href="kits_return_form.php" style='color:white'>
                                    <div class="col-lg-4">
                                        <div class="panel bg-teal-400">
                                            <p style="margin: 10px; font-size: large;">Return Form</p>
                                        </div>
                                    </div>
                                </a>
                                ...
                                <a href="bladder_inventory.php" style='color:white'>
                                    <div class="col-lg-4">
                                        <div class="panel bg-teal-400">
                                            <p style="margin: 10px; font-size: large;">Bladder Inventory Status</p>
                                        </div>
                                    </div>
                                </a>
