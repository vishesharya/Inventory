...
if (isset($_POST['delete_product'])) {
    ...
    if (isset($_SESSION['temp_products'][$delete_index])) {
        ...
        $stitcher_ist_company_ist = intval($temp_product['received_quantity']);
...
if (isset($_POST['submit_form'])) {
    ...
    if (empty($temp_products)) {
        ...
        foreach ($temp_products as $product) {
            ...
            $received_quantity = mysqli_real_escape_string($con, $product['received_quantity']);
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="received_quantity">received_quantity</label>
