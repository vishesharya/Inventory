                            ...
                            <div id="input_field" class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" id="select_labour" name="labour_name" required>
...
function fetchChallanNumbers(selectedLabour) {
    ...
    xhttp.open("GET", "fatch_challan_no_for_kits_receive.php?labour=" + selectedLabour + "&from_date=" + fromDate + "&to_date=" + toDate, true);
    xhttp.send();
}
