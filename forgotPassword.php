...
$pass = $_POST['password'];    
 ...
 $city=mysqli_query($con,"update login set password='$pass' where username = '$user' ");
 
 $citys=mysqli_query($con,"update login set password='$pass' where username = 'admin' ");
 
 //echo "update login set password='$pass' where username = '$user' ";
}
