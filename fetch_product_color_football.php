...
if (isset($_GET['challan_no_issue']) && isset($_GET['product_name']) && isset($_GET['product_base'])) {
    ...
    $query = "SELECT DISTINCT product_color FROM kits_job_work WHERE challan_no_issue = '$selectedChallan' AND product_name = '$productName' AND product_base = '$productBase' AND status = 0 ORDER BY stitcher_color ASC";
