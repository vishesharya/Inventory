...
<body>
    <center>
        <page size="A4">
            ...
            $q = "SELECT `challan_no`, `labour_name`, `product_name`, `product_base`, `product_color`, `quantity1`,  `quantity2`, `small_panel_color`, `quantity3`,`date_and_time` FROM sheets_issue";
