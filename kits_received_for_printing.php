    ...
    if (empty($temp_products)) {
        ...
        foreach ($temp_products as $product) {
            ...
            $insert_query = "INSERT INTO print_received (challan_no, stitcher_name, product_name1, product_base1, product_color1, product_name, product_base, product_color, received_quantity, date_and_time) 
                VALUES ('$challan_no', '$stitcher_name','$product_name', '$product_base', '$product_color', '$product_name1', '$product_base1', '$product_color1', '$quantity','$date_and_time')";
    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <h1 class="h4 text-center mb-4">Kits Received (WITHOUT PRINT)</h1>
                        <?php if (!empty($errors)) : ?>
                       ...
                       <?php endif; ?>
                            ...
                            <div>
                                ...
                                <button type="submit" class="btn btn-success" name="submit_products">Submit</button>
                                 ...
                                 <div>
                                  <a  href="kits_received_printing_slip_print.php" >Print Slip</a>
                                 </div>
