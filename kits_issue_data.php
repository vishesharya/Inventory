...
<head>
    ...
    <title><?php include('include/title.php');?> Kits Issue Data</title>
            ...
            <div class="content-wrapper">
                ...
                <div class="page-header page-header-default">
                    <div class="page-header-content">
                        <div class="page-title">
                            <h4><i class="icon-arrow-left52 position-left"></i> <a href="inventory.php" class="text-semibold">Kits Issue Data</a></h4>
                        </div>
                    ...
                    <div class="breadcrumb-line">
                        <ul class="breadcrumb">
                            ...
                            <li class="active"><a href="Kits_inventory_data.php" class="btn bg-indigo-300"  >Kits Inventory Data</a></li>
                        </ul>
                    </div>
                </div>
                <!-- /page header -->
                ...
                <div class="content">
                    <div class="pad margin no-print">
                        <div id="form" class="callout callout-info">
                            <form action="kits_issue_data_print.php" method="POST" class="form-horizontal" enctype="multipart/form-data"  autocomplete="off">
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <button type="submit" name="submit" class="btn btn-warning ">Print</button>
                                                 ...
                                                 <div>
                                                <a href="kits_issue_all_details.php">
                                                   <button type="#" name="#" class="btn btn-warning ">Print</button>
                                                </a>
                                               </div>
                        </div>
                    </div>
                ...
                <!-- Table of football contact query -->
                    ...
                    <div class="panel panel-flat" style="overflow: auto;">
                        <div class="panel-heading">
                            <h5 class="panel-title">Kits Inventory Management</h5>
                        ...
                        <table class="table datatable-multi-sorting">
                            ...
                            <tbody>
                                <?php 
                                $sn=1;
                                $result=mysqli_query($con, "SELECT * FROM kits_issue"); // Selecting all fields from the kits_issue table
